...
urlpatterns = [
	url(r'^$', autoSearch, name='autoSearch'),	# 默认全部列表
	...
	url(r'^showCaseList$', showCaseList, name='showCaseList'),	# 按品类分的列表
	...
	url(r'^caseConfirm/(.+)/$', caseConfirm, name='caseConfirm'),	# 编辑用例确认版本平台
	url(r'^editCaseStep$', editCaseStep, name='editCaseStep'),	# 编辑用例
	url(r'^saveCaseStep$', saveCaseStep, name='saveCaseStep'),	# 保持用例步骤信息
