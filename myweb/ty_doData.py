...
def do_contents():
	# 第一部分 头
	html_string0 = "<h3><font face='微软雅黑'> 简要接口报告 </font></h3><h4><span style='font-weight: normal;'><font face='微软雅黑'><font size='3'></font>&nbsp;<a href='http://10.115.1.73:8000/tyblog/' target='_blank'>查看更多图表和丰富数据</a></font></span></h4>"
	# 第二部分 占比图表
